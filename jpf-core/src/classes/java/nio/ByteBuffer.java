...
public class ByteBuffer extends Buffer {
	...
	ByteBuffer( int pos, int lim, int cap, // package-private
			byte[] hb) {
		super( pos, lim, cap);
		this.array = hb;
	}
	...
	public static ByteBuffer wrap(byte[] array, int offset, int length) {
		try {
			return new ByteBuffer(offset, offset + length, array.length, array);
    ...
    public ByteBuffer putShort(short x)  {
    		array[position] = (byte)(x >>  8);
    		array[position+1] = (byte)(x      );
    		position += 2;
    		return this;
    	}
	...
	public short getShort() {
		short x1 = (short) ((array[position  ]       ) << 8);
		short x0 = (short) (array[position+1] & 0xff);
		position += 2;
		return (short) (x1 | x0);
	}
