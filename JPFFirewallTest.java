...
import net.floodlightcontroller.routingoff.JPFLyhRoutingoff;
 ...
 * @author Amer Tahir
 */
public class JPFFirewallTest extends FloodlightTestCase {
    ...
    protected IPacket tcpPacketReply1;
    ...
    @Test
    public void testSimpleAllowRule(int srcAddresss1, int dstAddresss1) throws Exception {
        // enable firewall first
        firewall.enableFirewall(true);
        ...
        this.tcpPacketReply1 = new Ethernet()
                .setDestinationMACAddress("00:44:33:22:11:00")
                .setSourceMACAddress("00:11:22:33:44:55")
                .setVlanID((short) 42)
                .setEtherType(EthType.IPv4)
                .setPayload(
                        new IPv4()
                        .setTtl((byte) 128)
                        .setSourceAddress(srcAddresss1)
                        .setDestinationAddress(dstAddresss1)
                        .setPayload(new TCP()
                        .setSourcePort((short) 80)
                        .setDestinationPort((short) 81)
                        .setPayload(new Data(new byte[] {0x02}))));
        
        this.setPacketIn(tcpPacketReply1);
        firewall.receive(sw, this.packetIn, cntx);
//        verify(sw);
//
//        IRoutingDecision decision = IRoutingDecision.rtStore.get(cntx, IRoutingDecision.CONTEXT_DECISION);
...
//        assertEquals(RULE_MISS_COOKIE, decision.getDescriptor());
    ...
    public void testSimpleDropRule(int srcAddresss1, int dstAddresss1) throws Exception {
        // enable firewall first
        firewall.enableFirewall(true);
        ...
        rule.dl_src = MacAddress.of("00:00:00:00:00:01");
        rule.dl_dst = MacAddress.of("00:00:00:00:00:02");
        rule.nw_src_prefix_and_mask = IPv4AddressWithMask.of("192.168.1.1/32");
        rule.nw_dst_prefix_and_mask = IPv4AddressWithMask.of("192.168.1.4/32");
        rule.priority = 1;
    ...
    public static void main(String[] args) throws Exception{
    	IPv4 p = (IPv4) new IPv4().setTtl((byte) 128).setSourceAddress("192.168.1.1").setDestinationAddress("192.168.1.4")
    	        .setPayload(new UDP().setSourcePort((short) 5001).setDestinationPort((short) 5000).setPayload(new Data(new byte[] {0x02})));
    			int srcAddress1 = p.getSourceAddress().getInt();
    			int dstAddresss1 = p.getDestinationAddress().getInt();
    			JPFFirewallTest switcha = new JPFFirewallTest();
    			switcha.setUp ();
//    	    	switcha.testSimpleAllowRule (srcAddress1,dstAddresss1);
    	    	switcha.testSimpleDropRule (srcAddress1,dstAddresss1);
    	
    }
    	
//    	IPv4 p = (IPv4) new IPv4().setTtl((byte) 128).setSourceAddress("192.168.1.1").setDestinationAddress("192.168.1.3")
//    	        .setPayload(new UDP().setSourcePort((short) 5001).setDestinationPort((short) 5000).setPayload(new Data(new byte[] {0x02})));
//    			int srcAddress1 = p.getSourceAddress().getInt();
//    			int dstAddresss1 = p.getDestinationAddress().getInt();
//    			executefirewall(srcAddress1 , dstAddresss1);
//    				
//    			}
//    
//	public static void executefirewall(int srcAddresss1, int dstAddresss1) throws Exception {
//	    System.out.println(srcAddresss1+","+dstAddresss1);
//		IPv4Address srcIp1 = IPv4Address.of(srcAddresss1);
//		IPv4Address dstIp1 = IPv4Address.of(dstAddresss1);
//		JPFFirewallTest switcha = new JPFFirewallTest();
//		switcha.setUp();
//    	switcha.testSimpleAllowRule();
//    	
//    }
}
