 ...
 */
public class JPFHubTest extends FloodlightTestCase {
    protected OFPacketIn packetIn;
    protected IPacket testPacket;
    protected byte[] testPacketSerialized;
    protected IPacket testPacket2;
    protected byte[] testPacketSerialized2;
    ...
    @Test
    public void testFloodBufferId(int a, int b) throws Exception {
    	this.testPacket2 = new Ethernet()
                .setDestinationMACAddress("00:11:22:33:44:55")
                .setSourceMACAddress("00:44:33:22:11:00")
                .setEtherType(EthType.IPv4)
                .setPayload(
                    ...
                    .setTtl((byte) 128)
                    .setSourceAddress(a)
                    .setDestinationAddress(b)
                    .setPayload(new UDP()
                                .setSourcePort((short) 5000)
                                .setDestinationPort((short) 5001)
                                .setPayload(new Data(new byte[] {0x01}))));
            this.testPacketSerialized2 = testPacket.serialize();
            ...
            this.packetIn = (OFPacketIn) OFFactories.getFactory(OFVersion.OF_13).buildPacketIn()
                ...
                .setMatch(OFFactories.getFactory(OFVersion.OF_13).buildMatch()
                		.setExact(MatchField.IN_PORT, OFPort.of(1))
                		.build())
                .setData(this.testPacketSerialized2)
                .setReason(OFPacketInReason.NO_MATCH)
                .setTotalLen((short) this.testPacketSerialized2.length).build();
    ...
    public static void main(String[] args) throws Exception{
    	JPFHubTest jpfhub=new JPFHubTest();
    	jpfhub.setUp();
    	int a=1,b=2;
    	jpfhub.testFloodBufferId(a,b);
    	System.out.println("no buffer");
    	//jpfhub.testFloodNoBufferId();
    }
}
