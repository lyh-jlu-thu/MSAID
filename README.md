...
Don't worry. The specification of example demo and the introduction about the steps is coming (https://github.com/lyh-jlu-thu/MSAID/speficiation).
...
The detailed of the introduction about the codes is coming (https://github.com/lyh-jlu-thu/MSAID/introcode).
